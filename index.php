...
{
 $sql_query="DELETE FROM TutorForm WHERE id=".$_GET['delete_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
if(isset($_GET['changestatus_id']))
{
 $sql_query="UPDATE TutorForm SET `status`='".$_GET['status']."' WHERE id=".$_GET['changestatus_id'];
 mysqli_query($con,$sql_query);
 header("Location: $_SERVER[PHP_SELF]");
}
?>
...
function edt_id(id)
{
  window.location.href='edit_TutorForm.php?edit_id='+id;
}
function view_id(id)
{
  window.location.href='view_TutorForm.php?view_id='+id;
}
...
<div id="body">
 <div id="content">
    <table align="center">
    <tr>
    <th colspan="5"><a href="add_TutorForm.php">add TutorForm.</a></th>
    </tr>
    <th>SL NO</th>
    <th>Name</th>
    ...
    <?php
 $sql_query="SELECT * FROM TutorForm";
